...
# major modules should be install
from tkinter import *                     #create the gui of the project
...
# All the frames
song_frame = LabelFrame(root, text='Current Song', bg='LightBlue', width=450, height=90)
song_frame.place(x=0, y=0)

button_frame = LabelFrame(root, text='Control Buttons', bg='Turquoise', width=450, height=130)
button_frame.place(y=80)

listbox_frame = LabelFrame(root, text='Playlist Of the Song', bg='orange')
...
pause_btn = Button(button_frame, text='Pause', bg='lightgreen', font=("Georgia", 13), width=7,
...
resume_btn = Button(button_frame, text='Resume', bg='skyblue', font=("Georgia", 13), width=7,
...
Label(root, textvariable=song_status, bg='red', font=('Times', 9), justify=LEFT).pack(side=BOTTOM, fill=X)
